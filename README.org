...
The dragger should also be transparant. For this you can use the reorderlist-dragger class. Because the dragger takes over the computed style of the element that is being dragged around through javascript, all css properties of the dragger should be marked important. Sorry about that.
